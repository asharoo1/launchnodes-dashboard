...
export default function IncomeInEUR(props) {
  ...
  return (
    ...
    <Card>
      <CardHeader title="Income History in EUR" align="center"></CardHeader>
      <ChartWrapperStyle>
          ...
          <Table sx={{ minWidth: 100 }} aria-label="customized table">
            <TableBody>
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{dailyUsdIncome} EUR</strong>
                  ) : (
                    <strong>{dailyUsdIncome} EUR</strong>
                  )}
                </StyledTableCell>
              ...
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{weeklyUsdIncome} EUR</strong>
                  ) : (
                    <strong>{weeklyUsdIncome} EUR</strong>
                  )}
                </StyledTableCell>
              ...
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{monthlyUsdIncome} EUR</strong>
                  ) : (
                    <strong>{monthlyUsdIncome} EUR</strong>
                  )}
                </StyledTableCell>
