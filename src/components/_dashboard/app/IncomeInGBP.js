...
export default function IncomeInGBP(props) {
  ...
  return (
    ...
    <Card>
      <CardHeader title="Income History in GBP" align="center"></CardHeader>
      <ChartWrapperStyle>
          ...
          <Table sx={{ minWidth: 100 }} aria-label="customized table">
            <TableBody>
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{dailyUsdIncome} GBP</strong>
                  ) : (
                    <strong>{dailyUsdIncome} GBP</strong>
                  )}
                </StyledTableCell>
              ...
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{weeklyUsdIncome} GBP</strong>
                  ) : (
                    <strong>{weeklyUsdIncome} GBP</strong>
                  )}
                </StyledTableCell>
              ...
              <StyledTableRow>
                ...
                >
                  {performance1d > 0 ? (
                    <strong>+{monthlyUsdIncome} GBP</strong>
                  ) : (
                    <strong>{monthlyUsdIncome} GBP</strong>
                  )}
                </StyledTableCell>
